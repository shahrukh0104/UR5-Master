...
fileID = fopen('../data/log_library/controller_gain_estimation_force/PI-controller/Ki=0.0000001');
...
fileID1 = fopen('../data/log_library/controller_gain_estimation_force/PI-controller/Ki=0.0000005');
