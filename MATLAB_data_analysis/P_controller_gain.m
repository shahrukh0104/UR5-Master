...
fileID = fopen('../data/log_library/controller_gain_estimation_force/P-controller/Kp=0.001');
...
fileID1 = fopen('../data/log_library/controller_gain_estimation_force/P-controller/Kp=0.005');
...
fileID2 = fopen('../data/log_library/controller_gain_estimation_force/P-controller/Kp=0.0075');
...
fileID3 = fopen('../data/log_library/controller_gain_estimation_force/P-controller/Kp=0.01');
...
%% Load data from test 6
fileID4 = fopen('../data/log_library/controller_gain_estimation_force/P-controller/Kp=0.015');
...
fileID5 = fopen('../data/log_library/controller_gain_estimation_force/P-controller/Kp=0.02');
...
plot(elapsTime5(:), -Forces5(:,3));


plot(elapsTime(:), ones(size(Forces))*2);
hold off;
%lgd = legend('\fontsize{15} Referance force','\fontsize{15} K_p = 0.0025', '\fontsize{15} K_p = 0.0050', '\fontsize{15} K_p = 0.0075', '\fontsize{15} K_p = 0.0100','Location','east');
