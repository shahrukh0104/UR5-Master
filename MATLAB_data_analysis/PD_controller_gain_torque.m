...
fileID = fopen('../data/log_library/controller_gain_estimation_torque/PD-controller-torque/Kp=0.45_Kd=0.0005');
...
fileID1 = fopen('../data/log_library/controller_gain_estimation_torque/PD-controller-torque/Kp=0.45_Kd=0.05');
...
fileID2 = fopen('../data/log_library/controller_gain_estimation_torque/PD-controller-torque/Kp=0.45_Kd=1');
...
fileID3 = fopen('../data/log_library/controller_gain_estimation_torque/PD-controller-torque/Kp=0.45_Kd=5');
...
fileID4 = fopen('../data/log_library/controller_gain_estimation_torque/PD-controller-torque/Kp=0.45_Kd=10');
...
legend({'Reference Torque', 'K_d=0.0005', 'K_d = 0.05', 'K_d = 1', 'K_d = 5', 'K_d = 10'}, 'Location', 'southeast', 'Fontsize', 14);
%title(lgd,'Gain parameters','FontSize',15)
title('PD-controller - Step response for Ty','FontSize',15);
xlabel('Time [s]', 'FontSize',15)
ylabel('Torque [Nm]', 'FontSize',15)
grid on;
hold off;

%export_fig TorquePDcont -eps -transparent
